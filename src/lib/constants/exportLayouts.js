export const DOCX_LAYOUT_OPTIONS = [
  {
    ...
    columnStyles: [
      {
        content: '#',
        class: 'col-span-1 bg-slate-200 dark:bg-slate-700 p-0.5 rounded text-center truncate'
      },
      {
        content: 'Time',
        class: 'col-span-2 bg-slate-200 dark:bg-slate-700 p-0.5 rounded text-center truncate'
      },
      {
        content: 'Spk',
        class: 'col-span-2 bg-slate-200 dark:bg-slate-700 p-0.5 rounded text-center truncate'
      ...
      {
        content: 'Text',
        class: 'col-span-5 bg-slate-200 dark:bg-slate-700 p-0.5 rounded text-center truncate'
      }
    ]
  },
  {
    ...
    columnStyles: [
      ...
      {
        content: 'Time',
        class: 'col-span-3 bg-slate-200 dark:bg-slate-700 p-0.5 rounded text-center truncate'
      },
      // Row 2
      {
        content: 'Spk',
        class:
          'col-span-1 row-start-2 bg-slate-300 dark:bg-slate-600 p-0.5 rounded text-center truncate'
      },
      {
        content: 'Text',
        class:
          'col-span-3 row-start-2 bg-slate-300 dark:bg-slate-600 p-0.5 rounded text-center truncate'
      }
    ]
  },
  {
    ...
    columnStyles: [
      ...
      },
      {
        content: 'Text',
        class:
          'col-span-2 row-start-2 bg-slate-300 dark:bg-slate-600 p-0.5 rounded text-center truncate'
      }
    ]
  },
  {
    ...
    columnStyles: [
      ...
      {
        content: 'Text',
        class: 'col-span-7 bg-slate-200 dark:bg-slate-700 p-0.5 rounded text-center truncate'
      } // Approx 75%
    ]
  },
  {
