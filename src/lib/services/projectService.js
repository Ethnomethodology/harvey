...
export async function loadTranscriptFile(transcriptFilePath) {
    console.log('[Service loadTranscriptFile] Received path:', transcriptFilePath);
    ...
    try {
        ...
        console.log('[Service loadTranscriptFile] About to setTranscriptData with path:', transcriptFilePath, 'Num segments:', segmentsArray ? segmentsArray.length : 'N/A');
