  ...
  <div class="toolbar flex items-center flex-wrap gap-x-1 border-b border-gray-300 dark:border-gray-600 p-1 flex-shrink-0">
      ...
      {#if toolbarConfig.outdent}
        <button class="mini-toolbar-button" on:click={outdentContent} title="Outdent" disabled={!editable}>
            <svg class="w-[1em] h-[1em] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
