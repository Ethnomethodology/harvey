      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md" on:click|stopPropagation>
        ...
        <div class="grid grid-cols-10 gap-1 mb-4">
          {#each colors as color}
            <button
              type="button"
              class="w-6 h-6 rounded-full border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-900"
         ...
         <div class="flex items-center mb-6">
             ...
             <input type="text" bind:value={selectedColor} class="w-full px-3 py-1 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
         </div>
