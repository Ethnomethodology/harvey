...
<script>
    ...
    import { Volume2, Volume1, VolumeX, Minimize2, Maximize2, Expand, Shrink, Play, Pause, Rewind, FastForward, Camera, Subtitles, MoreVertical, Maximize, FileOutput } from 'lucide-svelte';
