...
<script>
  ...
  const typeStyles = {
    ...
    default: { bg: 'bg-gray-100 dark:bg-d-gray-700',    border: 'border-gray-500 dark:border-border',    text: 'text-gray-700 dark:text-d-gray-200',      iconFill: 'fill-gray-600 dark:fill-d-gray-400',      iconPath: 'M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z' } // Default uses info icon
  };
