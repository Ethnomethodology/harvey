<!-- src/lib/components/projectview/shared/_FileEarmarkCodeIcon.svelte -->
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-code" viewBox="0 0 16 16" {...$$props}>
