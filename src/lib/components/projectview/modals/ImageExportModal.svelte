...
<script>
  ...
  function handleConfirm() {
    ...
    const dir = normalizedDir.endsWith(PATH_SEPARATOR) ? normalizedDir.slice(0, -1) : normalizedDir;
...
>
  ...
  <div class="space-y-5">
    ...
    {#if showAnnotations}
      <div class="pt-2">
        <Checkbox bind:checked={includeAnnotations}>Include Annotations</Checkbox>
      </div>
    {/if}
  </div>
