<script>
  ...
  async function handleDelete() {
    const confirmed = await confirm(
      `Are you sure you want to delete the group "${group.name}"? All tags within this group will be deleted. Highlights will remain but will be untagged.`,
      {
...
>
  <div slot="header" class="flex items-center gap-2">
    ...
    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Tag Group</h3>
  </div>
