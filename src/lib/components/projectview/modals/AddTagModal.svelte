...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4" on:click={closeModal}>
    <div class="bg-white dark:bg-surface-2 p-6 rounded-lg shadow-xl w-full max-w-md" on:click|stopPropagation>
        <h2 class="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-100">Add New Tag</h2>
        ...
        <form on:submit|preventDefault={handleSave}>
            <div class="mb-4">
                <label for="tagName" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tag Name <span class="text-red-500">*</span></label>
                <input
                    type="text"
                    id="tagName"
