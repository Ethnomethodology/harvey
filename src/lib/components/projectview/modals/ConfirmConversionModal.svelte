...
>
	...
	<div class="space-y-3">
		<p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
            The file "<span class="font-semibold text-gray-900 dark:text-white">{fileName}</span>" needs to be converted to
            <span class="font-semibold text-blue-600 dark:text-blue-400">{targetFormat}</span> before it can be imported.
        </p>
	...
	<svelte:fragment slot="footer">
		<Button color="alternative" on:click={handleCancel} title="Cancel and go back">
			Cancel
		</Button>
