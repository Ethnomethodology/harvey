...
{#if visible}
  <div
    class="absolute bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 shadow-lg p-2 rounded-md z-50 text-xs text-gray-800 dark:text-gray-200 max-w-xs"
