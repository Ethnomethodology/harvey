...
<div class="h-full flex flex-col bg-white dark:bg-gray-800 rounded-md shadow p-2 space-y-2">
    ...
    <div class="toolbar flex items-center flex-wrap gap-x-1 border-b border-gray-300 dark:border-gray-600 pb-1 mb-1 flex-shrink-0">
...
<style lang="postcss">
    /* Styling (Unchanged) */
    .toolbar button.mini-toolbar-button, .toolbar select.mini-toolbar-select { @apply px-2 py-0.5 border border-gray-300 dark:border-gray-600 rounded bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-xs disabled:opacity-50 focus:outline-none focus:ring-1 focus:ring-blue-500; margin-right: 2px; } .toolbar select.mini-toolbar-select { height: 26px; } .toolbar button.mini-toolbar-button.active { @apply bg-blue-100 dark:bg-blue-800 border-blue-300 dark:border-blue-600 text-blue-800 dark:text-blue-200; } .separator { @apply w-px h-4 bg-gray-300 dark:bg-gray-600 mx-1 inline-block align-middle; } .lexical-wrapper { position: relative; } .lexical-minimal-content { outline: none; caret-color: currentcolor; height: 100%; }
