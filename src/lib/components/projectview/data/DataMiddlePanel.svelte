...
<style lang="postcss">
    /* Styling (Unchanged) */
    .toolbar button.mini-toolbar-button, .toolbar select.mini-toolbar-select { @apply px-2 py-0.5 border border-gray-300 dark:border-gray-700 rounded bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-xs disabled:opacity-50 focus:outline-none focus:ring-1 focus:ring-blue-500; margin-right: 2px; } .toolbar select.mini-toolbar-select { height: 26px; } .toolbar button.mini-toolbar-button.active { @apply bg-blue-100 dark:bg-blue-800 border-blue-300 dark:border-blue-600 text-blue-800 dark:text-blue-200; } .lexical-wrapper { position: relative; } .lexical-minimal-content { outline: none; caret-color: currentcolor; height: 100%; }
	...
	.lexical-wrapper::-webkit-scrollbar { @apply w-[8px] h-[8px]; } .lexical-wrapper::-webkit-scrollbar-track { @apply bg-gray-100 dark:bg-gray-900 rounded-lg; } .lexical-wrapper::-webkit-scrollbar-thumb { @apply bg-gray-400 dark:bg-gray-700 rounded-lg border-2 border-solid border-gray-100 dark:border-gray-900; } .lexical-wrapper::-webkit-scrollbar-thumb:hover { @apply bg-gray-500 dark:bg-gray-600; } .lexical-wrapper { scrollbar-width: thin; scrollbar-color: theme('colors.gray.400') theme('colors.gray.100'); } html.dark .lexical-wrapper { scrollbar-color: theme('colors.gray.700') theme('colors.gray.900'); }
</style>