...
<div class="flex flex-col h-full w-full bg-white dark:bg-dark-bg-primary shadow overflow-hidden">
  ...
  <path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966A.25.25 0 0 0 8 4.466"/>
            ...
            <button id="history-redo" class="p-1 border bg-gray-200 hover:bg-gray-300 dark:bg-dark-bg-tertiary dark:hover:bg-dark-bg-secondary" title="Redo">
  ...
  <path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466"/>
         ...
         <div class="flex items-center space-x-2">
            ...
            <button
              ...
              class="p-1 border bg-gray-200 hover:bg-gray-300 dark:bg-dark-bg-tertiary dark:hover:bg-dark-bg-secondary disabled:opacity-50 disabled:cursor-not-allowed"
