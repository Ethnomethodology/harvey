                        ...
                        <div class="border-t border-gray-100 dark:border-dark-bg-tertiary px-3 py-2 rounded-b-md flex flex-col bg-gray-50/30 dark:bg-dark-bg-secondary/50">
                            ...
                            <div class="flex justify-end w-full mt-2">
                                <button 
                                    ...
                                    class="relative p-1.5 rounded-md hover:bg-gray-200 dark:hover:bg-dark-bg-tertiary text-gray-500 dark:text-gray-400 transition-colors"
                                    title="View comments"
                                >
                                    ...
                                    {#if highlight.comments && highlight.comments.length > 0}
                                        <span class="absolute -top-1.5 -right-1.5 bg-blue-600 text-white text-[9px] font-bold rounded-full h-4 w-4 flex items-center justify-center border-2 border-white dark:border-surface-3">
