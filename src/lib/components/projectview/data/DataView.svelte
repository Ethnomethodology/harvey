...
<div class="flex flex-col h-full w-full bg-gray-100 dark:bg-app-bg-dark overflow-hidden">
	...
	<div class="flex flex-grow w-full min-h-0">
        ...
        <div class="flex-grow h-full min-w-0 border border-gray-300 dark:border-gray-600 -ml-px">
        ...
        {#if !$panelStateStore.infoPanelCollapsed && activeItemPath && activeViewType !== 'group_detail'}
            <div class="w-[20.588%] h-full flex-shrink-0 transition-all duration-300 ease-in-out border-l border-t border-b border-r border-gray-300 dark:border-gray-600 -ml-px" transition:slide="{{ duration: 300, axis: 'x' }}">
        ...
        {#if activeViewType !== 'group_detail' && activeItemPath}
            <div class="h-full flex-shrink-0 border border-gray-300 dark:border-gray-600 -ml-px">
