...
<div class="prose prose-sm dark:prose-invert max-w-none flex flex-col h-full w-full bg-white dark:bg-gray-800 shadow overflow-hidden exported-transcript">
    {#if isLoading}
