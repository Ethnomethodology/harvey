                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="p-2">
                                        <div class="flex space-x-2">
                                            <button title="Inspect"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                            ...
                                            <button title="Untag" on:click={() => handleUntag(item)}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tag-slash" viewBox="0 0 20 20">
                                                    <path
