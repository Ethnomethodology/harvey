...
<style lang="postcss">
    .input-field { @apply box-border px-1.5 py-1 border rounded appearance-none transition duration-150 ease-in-out focus:outline-none focus:ring-1 disabled:cursor-not-allowed;
        @apply bg-white text-gray-900 border-gray-300 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:border-gray-300;
        @apply dark:bg-surface-1 dark:text-text-primary dark:border-border dark:focus:ring-accent-primary dark:focus:border-accent-primary dark:disabled:bg-surface-2 dark:disabled:text-text-disabled dark:disabled:border-border;
    }
    .select-field { @apply border rounded text-sm transition duration-150 ease-in-out focus:outline-none focus:ring-1 disabled:cursor-not-allowed;
        @apply bg-white text-gray-900 border-gray-300 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:border-gray-300;
        @apply dark:bg-surface-1 dark:text-text-primary dark:border-border dark:focus:ring-accent-primary dark:focus:border-accent-primary dark:disabled:bg-surface-2 dark:disabled:text-text-disabled dark:disabled:border-border;
    }
    .size-6 { @apply w-6 h-6; } .size-5 { @apply w-5 h-5; }
    .btn-icon { @apply p-1 rounded transition duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed;
        @apply hover:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-blue-400 focus:bg-gray-200 disabled:hover:bg-transparent;
        @apply dark:hover:bg-accent-background-hover dark:focus:ring-accent-primary dark:ring-offset-surface-1 dark:focus:bg-accent-background-hover dark:disabled:hover:bg-transparent;
    }
    .btn-nav-vertical { @apply p-1 rounded-md transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed;
        @apply bg-gray-100 hover:bg-gray-200 text-gray-700 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-blue-400 focus:bg-gray-200;
        @apply dark:bg-surface-3 dark:hover:bg-accent-background-hover dark:text-text-secondary dark:focus:ring-accent-primary dark:ring-offset-surface-1 dark:focus:bg-accent-background-hover;
    }
    .lexical-editor-wrapper-style { display: flex; flex-direction: column; @apply border dark:border-border rounded overflow-hidden; }
    ...
    .lexical-editor-wrapper-style.is-disabled { @apply opacity-70 pointer-events-none;
        @apply bg-gray-100 border-gray-300;
        @apply dark:bg-surface-2 dark:border-border;
    }
    ...
    .lexical-editor-wrapper-style :global(.lexical-content) { @apply leading-normal whitespace-pre-wrap break-words min-h-0;
