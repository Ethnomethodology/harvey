...
<style lang="postcss">
    ...
    .input-field { @apply box-border px-1.5 py-1 border border-gray-300 rounded bg-white text-gray-900 dark:bg-surface-1 dark:text-text-primary dark:border-border appearance-none transition duration-150 ease-in-out focus:outline-none focus:ring-1 focus:ring-accent-primary focus:border-accent-primary disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed disabled:border-gray-300 dark:disabled:bg-surface-2 dark:disabled:text-text-disabled dark:disabled:border-gray-500; }
    .select-field { @apply border border-gray-300 rounded bg-white text-gray-900 text-sm dark:bg-surface-1 dark:text-text-primary dark:border-border transition duration-150 ease-in-out focus:outline-none focus:ring-1 focus:ring-accent-primary focus:border-accent-primary disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed disabled:border-gray-300 dark:disabled:bg-surface-2 dark:disabled:text-text-disabled dark:disabled:border-gray-500; }
    .size-6 { @apply w-6 h-6; } .size-5 { @apply w-5 h-5; }
    .btn-icon { @apply p-1 rounded hover:bg-gray-200 dark:hover:bg-accent-background-hover focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-blue-400 dark:focus:ring-accent-primary dark:ring-offset-gray-800 focus:bg-gray-200 dark:focus:bg-accent-background-hover transition duration-150 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-transparent dark:disabled:hover:bg-transparent; }
    .btn-nav-vertical { @apply p-1 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-surface-3 dark:hover:bg-accent-background-hover dark:text-text-secondary rounded-md disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-accent-primary dark:focus:ring-accent-primary dark:ring-offset-surface-1 focus:bg-gray-200 dark:focus:bg-accent-background-hover transition-colors flex items-center justify-center; }
    ...
    .lexical-editor-wrapper-style.is-disabled { @apply bg-gray-100 border-gray-300 opacity-70 dark:bg-surface-2 dark:border-border dark:opacity-70; pointer-events: none; }
    ...
    .lexical-editor-wrapper-style :global(.lexical-content) { @apply leading-normal whitespace-pre-wrap break-words text-gray-900 dark:text-text-primary; min-height: unset !important; font-family: Arial, Helvetica, sans-serif; font-size: 12pt; line-height: 1.5;}
