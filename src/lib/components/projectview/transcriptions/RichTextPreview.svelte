...
`;
    ...
    // This section will be removed by the overwrite
        ...
        <div bind:this={previewScrollContainerRef} class="flex-grow overflow-y-auto space-y-1 pr-1">
            ...
            {#each processedSegments as seg (seg.segmentIndex)}
                ...
                >
                    ...
                    <!-- Item 2: Main Content Block (Reverted to original structure) -->
                    <div class="flex flex-col flex-grow gap-y-1" style="width: 37.606rem;">
