...
<div class="h-full bg-white dark:bg-gray-800 rounded-md shadow flex flex-col overflow-hidden">
	<h2 class="relative flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300 h-auto pb-1 border-b border-gray-200 dark:border-gray-600 px-2 pt-2"
...
{:else}
    ...
    <div class="flex flex-col items-center space-y-2 px-2 pt-2 flex-grow overflow-y-auto min-h-0">
