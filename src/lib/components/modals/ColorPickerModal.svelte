...
<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100]" on:click|self={handleClose} role="dialog" aria-modal="true" aria-labelledby="color-picker-title">
    <div class="bg-white dark:bg-d-gray-800 p-6 rounded-lg shadow-xl w-full max-w-xs text-gray-900 dark:text-d-gray-100" on:click|stopPropagation>
        ...
        <div class="flex justify-end space-x-2 pt-4 border-t border-gray-200 dark:border-border">
            <button class="px-4 py-2 text-sm rounded-md bg-gray-200 hover:bg-gray-300 dark:bg-d-gray-600 dark:hover:bg-d-gray-500" on:click={handleClose}>Cancel</button>
