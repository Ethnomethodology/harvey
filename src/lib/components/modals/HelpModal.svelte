...
>
      ...
      <div class="flex flex-grow overflow-hidden h-full">
        <!-- Sidebar -->
        <div class="w-64 bg-gray-50 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 p-4 flex flex-col flex-shrink-0 overflow-y-auto font-sans transition-all duration-300">
          <nav class="flex flex-col space-y-1">
            {#each sidebarTabs as tab}
              <button
                class="px-4 py-2 text-sm rounded-md text-left transition-all duration-200 {currentPage.sidebarId === tab.id
