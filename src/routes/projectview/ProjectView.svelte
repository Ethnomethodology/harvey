...
$: hasCriticalConfigIssues = !$configStatus.python_libraries_installed || !$configStatus.hf_token_present || !$configStatus.transcription_models_downloaded || !$configStatus.diarization_model_downloaded;
$: hasTranslationIssueOnly = !hasCriticalConfigIssues && !$configStatus.translation_models_downloaded;
$: hasConfigIssues = hasCriticalConfigIssues || hasTranslationIssueOnly;
