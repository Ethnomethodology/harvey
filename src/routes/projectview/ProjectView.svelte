...
<div class="relative flex h-screen w-full font-sans text-sm text-gray-900 dark:text-gray-200 overflow-hidden">
	...
	<div class="w-12 h-full bg-white bg-gray-200 dark:bg-gray-600 shadow-lg flex flex-col flex-shrink-0 py-1 overflow-hidden border-r border-gray-300 dark:border-gray-700">
