...
<div class="relative flex flex-col h-screen w-full font-sans text-sm text-gray-900 dark:text-gray-200 overflow-hidden">
	...
	<div class="flex flex-grow w-full overflow-hidden min-h-0">
		<div class="w-12 h-full bg-white bg-gray-200 dark:bg-dark-bg-icon-bar shadow-lg flex flex-col flex-shrink-0 py-1 overflow-hidden border-r border-gray-300 dark:border-gray-700">
