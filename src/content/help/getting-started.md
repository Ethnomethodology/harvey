...
1.  **Initial Configuration**
    Before you begin, head to the **Configure tab**. You will need to install the required libraries and download your preferred AI models from the **Models** tab to enable all functionalities of the app. See [Configure](/help/configure) for more detail.
