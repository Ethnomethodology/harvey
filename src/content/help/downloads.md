...
Visit the [Latest Releases](https://github.com/Ethnomethodology/harvey/releases/tag/v0.1.2) page on GitHub to download Harvey for your platform.
...
## macOS
1.  **Download**: Visit the [GitHub Releases](https://github.com/Ethnomethodology/harvey/releases/tag/v0.1.2) page.
