...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            welcome::commands::download_crisper_whisper_model_command,
            ...
            welcome::commands::install_crisper_whisper_dependencies_command,
            ...
            projectview::view_commands::rename_table_view_command,
